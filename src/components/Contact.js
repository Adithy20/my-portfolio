  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const emailData = {
        ...
        to: 'Adithya Gowda S2007@gmail.com'
      };
      ...
      setSnackbar({
        open: true,
        message: 'Failed to send message. Please try again later or contact me directly at aadithyagowda20@gmail.com',
        severity: 'error'
      });
    } finally {
      setLoading(false);
                ...
                <Stack spacing={2.5} sx={{ flex: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                      ...
                      Gaddige, Karimuddanahalli Post in Hunsur Taluk, Mysore District, Karnataka, Pincode 571189
                      </Typography>
                    </Box>
                  </Box>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        <Button 
                          variant="text" 
                          sx={{ p: 0, minWidth: 'auto', textTransform: 'none' }}
                          onClick={() => window.open('https://wa.me/6364119490', '_blank')}     
                        >
                          click here
                        </Button>
                      </Typography>
                  ...
                  <Box sx={{ 
                    ...
                    <iframe
                      ...
                      title="Location Map - Gaddige, Hunsur Taluk, Mysore, Karnataka 571189"
                      src="https://www.google.com/maps?q=Gaddige,%20Karimuddanahalli%20Post,%20Hunsur%20Taluk,%20Mysore%20District,%20Karnataka%20571189&output=embed"
                    />
                  </Box>
                </Stack>
              </CardContent>
