        ...
        <Card sx={{ borderRadius: 3, boxShadow: 2, mb: 3 }}>
          <CardContent sx={{ py: 3 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', gap: 3 }}>
              <Button
                component="a"
                href="https://github.com/Adithya Gowda S2004"
                target="_blank"
                variant="outlined"
              ...
              <Button
                component="a"
                href="https://www.linkedin.com/in/Adithya-Gowda-S2004"
                target="_blank"
                variant="outlined"
              ...
              <Button
                component="a"
                href="mailto:aadithyagowda20@gmail.com"
                variant="outlined"
